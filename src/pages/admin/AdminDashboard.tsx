    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <motion.div
          ...
          className="p-6 rounded-2xl bg-indigo-600/10 border border-indigo-500/20 cursor-pointer hover:bg-indigo-600/20 transition-colors"
        ...
        <motion.div
          ...
          className="p-6 rounded-2xl bg-purple-600/10 border border-purple-500/20 cursor-pointer hover:bg-purple-600/20 transition-colors"
        ...
        <motion.div
          ...
          className="p-6 rounded-2xl bg-emerald-600/10 border border-emerald-500/20 cursor-pointer hover:bg-emerald-600/20 transition-colors"
        ...
        <motion.div
          ...
          className="p-6 rounded-2xl bg-rose-600/10 border border-rose-500/20 cursor-pointer hover:bg-rose-600/20 transition-colors"
